...
function createAction(module, filename) {
	...
	try {
		...
		console.log('Action file: %s created in module: %s', filename, module);
	}
}
...
function createComponent(module, filename) {
	...
	try {
		...
		console.log('Component file: %s created in module: %s', filename, module);
	}
}
...
function createStore(module, filename) {
	...
	try {
		...
		console.log('Store file: %s created in module: %s', filename, module);
	}
}
...
function createConstant(module, filename) {
	...
	try {
		...
		console.log('Constant file: %s created in module: %s', filename, module);
	}
}
